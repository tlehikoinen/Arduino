...
#define __ST7735_H__
  ...
  #define PORT                  PORTB
  #define DDR                   DDRB 
  #define ST7735_MOSI           2 // SDA
  #define ST7735_MISO           3
  #define ST7735_SCK            1 // SCL
  ...
  #define BLACK                 0x0000
  #define WHITE                 0xFFFF
  #define RED_DARK              0xF000
  #define RED_ORANGE			0xF800
  ...
  //#define SNAKE_BACKGROUND		BLACK
  //#define SNAKE_BODY			MAGENTA
  //#define SNAKE_APPLE			RED_DARK
  //#define MENU_BACKGROUND		BLACK
  //#define MENU_TEXT				MAGENTA
  //#define MENU_SELECT			RED_ORANGE
